...
<body style="background-color:rgba(0, 0, 0, 0.2);">
    ...
    <?php if (isset($_SESSION['message'])) : ?>
        <div class="alert alert-danger alert-dismissible fade show fade in bg-warning text-dark" role="alert">
            <?= $_SESSION['message']; ?>
    ...
    <div class="container">
            ...
            <div class="col-sm-4">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn btn-outline-warning " style="text-align: center;">View more</a>
                    </div>
                </div>
            </div>
        </div>
        <br>
        <div class="content">
            <h3 class="bg-dark text-white text-center">Football News</h3>
                    ...
                    ?><br>
                        <div class="col-sm-4">
                            ...
                            <div class="card-body">
                                ...
                                <a href="DetailArticle.php?id_article=<?= $data['id_article'] ?>" class="btn btn-warning">Tampilkan lebih lanjut</a>
                            </div>

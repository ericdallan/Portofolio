...
<head>
    ...
    <title>Register Member Premiumship</title>
...
<body style="background-color:rgba(0, 0, 0, 0.2);">
    ...
    <div class="card" style=" margin-left: 25% ; margin-right: 25%; background-color:white">
        <div class="card-body">
            <h5 class="card-title" style="text-align: center;">Register Premium Membership</h5>
            <div class="card-text">
                <hr width="100%">
                <form action="RegisterUser.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="text-center pt-2">
                        ...
                        <p class="mt-3">Already have account ? <a href="LoginUserAccountForm.php">Login</a></p>
                    </div>
                </form>
            </div>
        </div>

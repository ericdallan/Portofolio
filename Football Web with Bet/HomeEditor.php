        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="btn btn-outline-light" href="CreateArticleForm.php">Create Your Own Article</a>
                    </li>
                </ul>
                <form class="d-flex">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="UpdateEditor.php?id_editor=<?= $row['id_editor'] ?>" method="POST" enctype="multipart/form-data">
                        <div class="row mb-3">
            ...
            <div class="col-sm-4">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn btn-outline-primary" style="text-align: center;">View more</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="content">
            <h3 class="bg-primary text-white text-center">Football News</h3>
            <br>
                    ...
                    ?><br>
                        <div class="col-sm-4">
                            ...
                            <div class="card-body">
                                ...
                                <a href="DetailArticle.php?id_article=<?= $data['id_article'] ?>" class="btn btn-primary">Tampilkan lebih lanjut</a>
                            </div>

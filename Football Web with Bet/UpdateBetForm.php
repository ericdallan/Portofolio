...
<body style="background-color:rgba(0, 0, 0, 0.2);">
    ...
    <div class="card" style=" margin-left: 25% ; margin-right: 25%; background-color:white">
        <div class="card-body">
            <h5 class="card-title" style="text-align: center;">Bet Details</h5>
            <div class="card-text">
                <hr width="100%">
                <form action="UpdateBet.php?id_bet=<?= $display['id_bet'] ?>" method="POST" enctype="multipart/form-data">
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="inputStatus" name="inputStatus" value="Proceed" readonly>
                        </div>
                    </div>
                    <hr width="100%">
                    <div class="text-center pt-2">
                        <button type="submit" class="btn btn-primary" name="Update">Update Bet</button>
                    </div>
                </form>
            </div>
        </div>
